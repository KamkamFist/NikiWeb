...
const posts = [
  ...
  {
    url: "https://www.instagram.com/p/DOLGJ0OiKBk/",
  ...
  {
    url: "https://www.instagram.com/kicia.projects/p/DOqFxy2CGPy/",
  ...
  {
    url: "https://www.instagram.com/kicia.projects/p/DNkPv1rIeAW/",
  ...
  {
    url: "https://www.instagram.com/kicia.projects/p/DN0_uTZUEFm/",
  ...
  return (
    <>
      ...
      <div id="down">
        ...
        <div id="Arts">
          {posts.map((x) => (
            <a href={x.url}   key={x.url} className='art'>
